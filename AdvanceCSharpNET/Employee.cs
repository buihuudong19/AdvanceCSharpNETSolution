namespace AdvanceCSharpNET;//namespace, class, interface, delegate
public class Employee : Person /*IS-A*/
{
    ...
    public Employee(int id, string? name, DateOnly dob, string? address, int workHour, double salaryRate) : base(name, dob, address)
    {
    ...
    {
        return $"Id: {Id} {base.Print()} Work Hour: {WorkHour} and Rate Salary: {SalaryRate}";
    }
